...
// Human-readable timestamp for brand stamp
...
// Filename-safe timestamp: 20251205_235714
function getISTFilenameTimestamp() {
  ...
  // Convert "05/12/2025, 23:57:14" → "20251205_235714"
...
sheet.columns = [
  ...
  { header: "error_reason", key: "error", width: 60 } 
];
...
// -------------------------
// Brand Stamp (Footer Note)
// -------------------------

const lastRow = sheet.rowCount + 2; // one blank row + stamp row

const stampLine1 = "Generated by Image ALT AI with ♥";
const stampLine2 = "on " + getISTHumanTimestamp() + " IST";
...
const outName = `bulk_imagealtai_output_${getISTFilenameTimestamp()}.xlsx`;
