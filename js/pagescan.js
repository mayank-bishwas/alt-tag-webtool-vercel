  ...
  async function handleScan() {
    ...
    try {
      ...
      if (scannedImages.length === 0) {
        scanError.innerHTML = `No valid images detected on this page.<br> <a href="index.html" target="_blank" style="color:#3b66ff; text-decoration:underline;"> Try uploading manually↗</a>.`;
...
function createCSV() {
    ...
    csv += `,Generated by Image SEO Checker with ♥ on ${getISTTimestamp()}\n`;
  ...
  function autoDownloadCSV(csv) {
    ...
    a.href = url;
    a.download = `pagescan_image_seo_output_${istFilenameTimestamp()}.csv`;
    a.click();
